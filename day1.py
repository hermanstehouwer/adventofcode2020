...
from readers.read_lists import read_list_ints_sorted
from core.findsum import find_inputs_that_sumto
import math


def both(number_of_inputs:int = 2):
    with read_list_ints_sorted("data/day1_input.txt") as intlist:
...
if __name__ == "__main__":
    ...
    with read_list_ints_sorted("data/day1_input_boudewijn.txt") as intlist:
        iterations = 100
